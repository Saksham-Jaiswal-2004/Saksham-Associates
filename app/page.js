        ...
        <div className="h-fit mb-24 flex flex-wrap items-center">
          <div className="md:w-1/2 w-full p-10 flex flex-col gap-4">
            ...
            <div className="my-6 w-full flex flex-wrap justify-start items-start gap-4">
              <Link  href="#cta" className="button2 px-4 py-4 rounded-xl text-base">Bring Your Vision to Life Now</Link>
              <Link href="/Portfolio" className="button3 px-4 py-4 rounded-xl text-base">Explore Our Interior Design Projects</Link>
            </div>
          </div>
