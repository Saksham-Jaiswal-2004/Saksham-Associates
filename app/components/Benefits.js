  ...
  return (
    <div className='bg6 h-fit md:my-32 my-24 flex flex-col justify-center items-center' id='benefits'>
      ...
      <div className='flex flex-wrap h-fit justify-center items-center py-2'>
        <div className='w-[70%] flex md:flex-col flex-wrap items-center justify-center gap-2'>
          <div className='w-full h-fit flex gap-4 md:flex-row flex-col'>
            <div>
              <div className='my-3 w-full bg-black/40 p-4 rounded-xl hover:bg-black/60 transition-all duration-200 ease-in-out'>
                <h1 className='md:text-2xl text-base mb-3'>1.Enhanced Aesthetics & Elegant Interiors</h1>
              ...
              <div className='my-3 w-full bg-black/40 p-4 rounded-xl hover:bg-black/60 transition-all duration-200 ease-in-out'>
                <h1 className='md:text-2xl text-base mb-3'>2.Maximized Functionality with Smart Space Planning</h1>
            ...
            <div className='my-3 w-full bg-black/40 p-4 rounded-xl hover:bg-black/60 transition-all duration-200 ease-in-out'>
              <h1 className='md:text-2xl text-base mb-3'>3.Eco-Friendly & Sustainable Interior Design</h1>
          ...
          <div className='flex gap-4 md:flex-row flex-col'>
            <div className='my-3 w-full bg-black/40 p-4 rounded-xl hover:bg-black/60 transition-all duration-200 ease-in-out'>
              <h1 className='md:text-2xl text-base mb-3'>4.Increased Property Value Through Smart Design</h1>
            ...
            <div className='my-3 w-full bg-black/40 p-4 rounded-xl  hover:bg-black/60 transition-all duration-200 ease-in-out'>
              <h1 className='md:text-2xl text-base mb-3'>5.Interiors That Improve Your Well-Being</h1>
          ...
          <div className='w-full flex justify-end'>
            <Link
              href="#contact"
              className='my-5 mx-3 button3 px-4 md:py-3 py-2 rounded-xl md:text-lg text-base'
