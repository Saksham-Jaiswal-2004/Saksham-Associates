    ...
    <div className='h-fit md:my-32 my-24 flex flex-col items-center' id='services'>
      ...
      <div className='md:w-[95%] w-100% h-fit'>
        <div className='flex flex-wrap w-full items-center justify-center md:my-4 my-1 md:m-2 m-1 border'>
          <div className='relative rounded-xl md:w-[35%] w-[95%] md:h-[250px] h-[150px] overflow-hidden md:m-2 m-1 cursor-pointer'>
          ...
          <div className='relative rounded-xl md:w-[22%] w-[38%] md:h-[250px] h-[150px] overflow-hidden md:m-2 m-1 cursor-pointer'>
          ...
          <div className='relative rounded-xl md:w-[22%] w-[55%] md:h-[250px] h-[150px] overflow-hidden md:m-2 m-1 cursor-pointer'>
