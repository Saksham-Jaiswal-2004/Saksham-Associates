...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <div ref={divRef} className={`fixed py-4 px-8 z-[102] top-0 left-0 w-fit h-full backdrop-blur-md bg-[#33333380] text-white flex flex-col items-center justify-start space-y-8 text-2xl transition-transform duration-300 z-40"}`}  style={{transform: isOpen ? `translateX(${screenWidth - divWidth - 4}px)` : `translateX(${screenWidth}px)`,}}>
