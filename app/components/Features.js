  ...
  return (
    <div className='h-fit md:my-32 my-24 flex flex-col justify-center items-center' id='features'>
      ...
      <div className='flex flex-wrap justify-center items-center'>
        <div className='flex card1 flex-col lg:w-[19%] md:w-[25%] w-[46%] h-[280px] p-4 rounded-lg mx-1 my-3 shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl'>
        ...
        <div className='flex card1 flex-col lg:w-[19%] md:w-[25%] w-[50%] h-[280px] p-4 rounded-lg mx-1 my-3 shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl'>
