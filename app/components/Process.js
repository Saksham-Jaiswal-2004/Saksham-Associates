    ...
    <div className='h-fit md:my-32 my-24 flex flex-col items-center' id='hiw'>
      ...
      <div className='w-full flex flex-wrap gap-2 justify-center items-center md:my-10 my-2'>
        ...
        <div className='h-[330px] md:w-[23%] w-[48%] p-3'>
          <img src="images/hiw1.svg" alt="" className='w-full h-[200px] my-4'/>
        ...
        <div className='h-[330px] md:w-[23%] w-[48%] p-3'>
          <img src="images/hiw2.svg" alt="" className='w-full h-[200px] my-4'/>
        ...
        <div className='h-[330px] md:w-[23%] w-[48%] p-3'>
          <img src="images/hiw3.svg" alt="" className='w-full h-[200px] my-4'/>
        ...
        <div className='h-[330px] md:w-[23%] w-[48%] p-3'>
          <img src="images/hiw4.svg" alt="" className='w-full h-[200px] my-4'/>
